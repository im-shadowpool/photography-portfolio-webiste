...
const Gallery = () => {
  ...
  useEffect(() => {
    ...
    const totalSlideCount = galleryData.length;
    ...
    function createSlideElement(index) {
      ...
      img.src = galleryData[dataIndex].img;
      ...
      slide.addEventListener("click", (e) => {
        ...
        if (state.dragDistance < 10 && !state.hasActuallyDragged) {
          router.push(galleryData[dataIndex].url);
        }
      });
    ...
    function updateParallax() {
      ...
      state.slides.forEach((slide) => {
        ...
        img.style.transform = `translateX(${parallaxOffset}px) scale(2)`;
      });
    }
